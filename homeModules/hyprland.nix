  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        {
          _args = [
            "SUPER + A"
            (inline ''hl.dsp.exec_cmd("rofi-powermenu")'')
          ];
        }
        {
          _args = [
            "SUPER + Q"
            (inline ''hl.dsp.exec_cmd("kitty")'')
          ];
        }
        {
          _args = [
        ...
        }
        {
          _args = [
            "SUPER + E"
            (inline ''hl.dsp.exec_cmd("kitty -e btop")'')
          ];
        }
        {
          _args = [
            "SUPER + T"
            (inline ''hl.dsp.exec_cmd("thunar")'')
          ];
        }
        {
          _args = [
            "SUPER + G"
            (inline ''hl.dsp.exec_cmd("kitty -e lf")'')
          ];
        }
        {
          _args = [
        ...
        }
        {
          _args = [
            "SUPER + R"
            (inline ''hl.dsp.exec_cmd("rofi-launcher")'')
          ];
        }
        {
          _args = [
            "SUPER + N"
            (inline ''hl.dsp.exec_cmd("swaync-client -t")'')
          ];
        }
        {
          _args = [
            "SUPER + L"
            (inline ''hl.dsp.exec_cmd("hyprlock")'')
          ];
        }
        {
          _args = [
        ...
        }
        {
          _args = [
            "SUPER + F"
            (inline ''hl.dsp.exec_cmd("firefox")'')
          ];
        }
        {
          _args = [
            "SUPER + B"
            (inline "hl.dsp.window.fullscreen()")
          ];
        }
        {
          _args = [
            "SUPER + SHIFT + F"
            (inline ''hl.dsp.exec_cmd("firefox --private-window")'')
          ];
        }
        {
          _args = [
        ...
        }
        {
          _args = [
            "SUPER + code:14"
            (inline ''hl.dsp.focus({ workspace = 5 })'')
          ];
        }
        {
          _args = [
            "SUPER + code:15"
            (inline ''hl.dsp.focus({ workspace = 6 })'')
          ];
        }
        {
          _args = [
            "SUPER + code:16"
            (inline ''hl.dsp.focus({ workspace = 7 })'')
          ];
        }
        {
          _args = [
            "SUPER + code:17"
            (inline ''hl.dsp.focus({ workspace = 8 })'')
          ];
        }
        {
          _args = [
            "SUPER + code:18"
            (inline ''hl.dsp.focus({ workspace = 9 })'')
          ];
        }
        {
          _args = [
            "SUPER + code:19"
            (inline ''hl.dsp.focus({ workspace = 10 })'')
          ];
        }
        {
          _args = [
        ...
        }
        {
          _args = [
            "SUPER + SHIFT + code:14"
            (inline ''hl.dsp.window.move({ workspace = 5 })'')
          ];
        }
        {
          _args = [
            "SUPER + SHIFT + code:15"
            (inline ''hl.dsp.window.move({ workspace = 6 })'')
          ];
        }
        {
          _args = [
            "SUPER + SHIFT + code:16"
            (inline ''hl.dsp.window.move({ workspace = 7 })'')
          ];
        }
        {
          _args = [
            "SUPER + SHIFT + code:17"
            (inline ''hl.dsp.window.move({ workspace = 8 })'')
          ];
        }
        {
          _args = [
            "SUPER + SHIFT + code:18"
            (inline ''hl.dsp.window.move({ workspace = 9 })'')
          ];
        }
        {
          _args = [
            "SUPER + SHIFT + code:19"
            (inline ''hl.dsp.window.move({ workspace = 10 })'')
          ];
        }
        {
          _args = [
        ...
        }
        {
          _args = [
            "SUPER + mouse_down"
            (inline ''hl.dsp.focus({ workspace = "e+1" })'')
          ];
        }
        {
          _args = [
        ...
        }
        {
          _args = [
            "Print"
            (inline ''hl.dsp.exec_cmd("grim -g \"$(slurp)\" - | swappy -f -")'')
          ];
        }
        {
          _args = [
            "CTRL + ALT + V"
            (inline ''hl.dsp.exec_cmd("cliphist list | wofi --dmenu | cliphist decode | wl-copy")'')
          ];
        }
      ];
      ...
      binde = [
        {
          _args = [
            ...
            (inline ''hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SINK@ 0 && wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 5%+")'')
            { repeating = true; }
          ];
        }
        {
      ...
      bindl = [
        {
          _args = [
            ...
            (inline ''hl.dsp.exec_cmd("hyprctl dispatch dpms off")'')
            { locked = true; }
          ];
        }
        {
          _args = [
            ...
            (inline ''hl.dsp.exec_cmd("hyprctl dispatch dpms on")'')
            { locked = true; }
          ];
        }
      ];
      ...
      window_rule = [
        ...
        {
          match.title = "^(Suppression des cookies.*)$";
          float = true;
          size = [ 490 154 ];
          center = true;
        }
        ...
        {
          match.class = "^(disk-monitor)$";
          float = true;
          size = [ 1200 800 ];
          center = true;
        }
        {
          match.class = "^(system-monitor)$";
          float = true;
          size = [ 1200 800 ];
          center = true;
        }
        ...
        {
          match.title = "^(Steam Guard|Paramètres Steam|Liste de contacts|Offres spéciales)$";
          float = true;
        }
        {
        ...
        {
          match.class = "^(minecraft-launcher|gamemoderun|heroic|legendary|bottles|retroarch|dolphin-emu|pcsx2-qt|rpcs3|yuzu|citra|hl2_linux|csgo_linux64|dota2)$";
          fullscreen = true;
        }
        {
          match.class = "^(codium)$";
