    ...
    settings = [
      {
        ...
        "custom/notification" = {
          ...
          format-icons = {
            ...
            none = "󰂚";
            dnd-notification = "<span foreground='${stylix.base08}'>󰂛</span>";
            dnd-none = "󱏧";
            inhibited-notification = "<span foreground='${stylix.base08}'>󰂚</span>";
            inhibited-none = "󰂚";
            dnd-inhibited-notification = "<span foreground='${stylix.base08}'>󰂛</span>";
